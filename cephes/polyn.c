...
/* Set a = 0.
 */
void polclr(a, n) register double* a;
int n;
{
    int i;
...
/* Set b = a.
 */
void polmov(a, na, b) register double *a, *b;
int na;
{
    int i;
...
/* c = b * a.
 */
void polmul(a, na, b, nb, c) double a[], b[], c[];
int na, nb;
{
    int i, j, k, nc;
    double x;
...
/* c = b + a.
 */
void poladd(a, na, b, nb, c) double a[], b[], c[];
int na, nb;
{
    int i, n;
...
/* c = b - a.
 */
void polsub(a, na, b, nb, c) double a[], b[], c[];
int na, nb;
{
    int i, n;
...
void polsbt(a, na, b, nb, c) double a[], b[], c[];
int na, nb;
{
    int i, j, k, n2;
    double x;
