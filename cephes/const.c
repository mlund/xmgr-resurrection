 ...
 * mconf.h.
 *
 * Modified 8 April 1998 by John.Hasstedt@sunysb.edu to define
 * the proper values for G floating point if DEC and __G_FLOAT
 * are defined.  __G_FLOAT is defined by the DECC compiler if
 * it is invoked with /FLOAT=G_FLOAT.
 *
 ...
 *
 * For DEC/__G_FLOAT mode:
 * MACHEP =  1.1102230246251565404236E-16
 * MAXLOG =  7.0908956571282408276602E2
 * MINLOG = -7.0978271289338397309621E2
 * MAXNUM =  8.9884656743115785407264E307
 *
...
#ifdef DEC
#if __G_FLOAT
double MACHEP = 1.1102230246251565404236E-16;
double UFLOWTHRESH = 5.5626846462680034577256E-309;
double MAXLOG = 7.0908956571282408276602E2;
double MINLOG = -7.0978271289338397309621E2;
double MAXNUM = 8.9884656743115785407264E307;
double PI     =  3.14159265358979323846;       /* pi */
double PIO2   =  1.57079632679489661923;       /* pi/2 */
double PIO4   =  7.85398163397448309616E-1;    /* pi/4 */
double SQRT2  =  1.41421356237309504880;       /* sqrt(2) */
...
double THPIO4 =  2.35619449019234492885;       /* 3*pi/4 */
double TWOOPI =  6.36619772367581343075535E-1; /* 2/pi */
double INFINITY =  8.9884656743115785407264E307;
double NAN = 0.0;
double NEGZERO = 0.0;
#else /* __G_FLOAT == 0 */
...
/*
 * Get more reliable definitions of UFLOWTHRESH and MAXNUM from math.h
 * if possible
 */

#if defined (HAVE_LIBM)
#  if defined (DBL_MIN)
#    define UFLOWTHRESH = DBL_MIN
#  endif
#  if defined (DBL_MAX)
