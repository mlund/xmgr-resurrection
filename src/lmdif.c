...
/* Subroutine */ int fdjac2_(S_fp fcn, integer* m, integer* n, doublereal* x, doublereal* fvec, doublereal* fjac,
...
/* Subroutine */ int lmdif_(S_fp fcn, integer* m, integer* n, doublereal* x, doublereal* fvec, doublereal* ftol,
                            ...
                            doublereal* fjac, integer* ldfjac, integer* ipvt, doublereal* qtf, doublereal* wa1,
    ...
    extern /* Subroutine */ int qrfac_(integer*, integer*, doublereal*, integer*, logical*, integer*, integer*,
                                       doublereal*, doublereal*, doublereal*),
        lmpar_(integer*, doublereal*, integer*, integer*, doublereal*, doublereal*, doublereal*, doublereal*,
               doublereal*, doublereal*, doublereal*, doublereal*);
    static doublereal ratio;
    extern doublereal enorm_(integer*, doublereal*);
    static doublereal fnorm, gnorm;
    extern /* Subroutine */ int fdjac2_(S_fp, integer*, integer*, doublereal*, doublereal*, doublereal*, integer*,
    ...
    *nfev = 0;
    ...
    if (*n <= 0 || *m < *n || *ldfjac < *m || *ftol < zero || *xtol < zero || *gtol < zero || *maxfev <= 0 ||
        *factor <= zero) {
        goto L300;
    }
    if (*mode != 2) {
...
L30:
    ...
    iflag = 2;
    fdjac2_((S_fp)fcn, m, n, &x[1], &fvec[1], &fjac[fjac_offset], ldfjac, &iflag, epsfcn, &wa4[1]);
    *nfev += *n;
    if (iflag < 0) {
        goto L300;
    }
...
L200:
    ...
    lmpar_(n, &fjac[fjac_offset], ldfjac, &ipvt[1], &diag[1], &qtf[1], &delta, &par, &wa1[1], &wa2[1], &wa3[1],
           &wa4[1]);
...
/* Subroutine */ int lmpar_(integer* n, doublereal* r__, integer* ldr, integer* ipvt, doublereal* diag, doublereal* qtb,
                            doublereal* delta, doublereal* par, doublereal* x, doublereal* sdiag, doublereal* wa1,
                            doublereal* wa2) {
    /* Initialized data */
    ...
    extern /* Subroutine */ int qrsolv_(integer*, doublereal*, integer*, integer*, doublereal*, doublereal*,
                                        doublereal*, doublereal*, doublereal*);
...
L150:
    ...
    qrsolv_(n, &r__[r_offset], ldr, &ipvt[1], &wa1[1], &qtb[1], &x[1], &sdiag[1], &wa2[1]);
    i__1 = *n;
    for (j = 1; j <= i__1; ++j) {
        wa2[j] = diag[j] * x[j];
        /* L170: */
...
/* Subroutine */ int qrfac_(integer* m, integer* n, doublereal* a, integer* lda, logical* pivot, integer* ipvt,
...
/* Subroutine */ int qrsolv_(integer* n, doublereal* r__, integer* ldr, integer* ipvt, doublereal* diag,
    ...
    for (j = 1; j <= i__1; ++j) {
        ...
        for (k = j; k <= i__2; ++k) {
            ...
            if ((d__1 = r__[k + k * r_dim1], abs(d__1)) >= (d__2 = sdiag[k], abs(d__2))) {
                goto L40;
            }
