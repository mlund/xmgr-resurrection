...
@    string just 0
@    string char size 1.000000
@string def "To fit the parameters a0 and a1, open Data/Transformations/Non-linear"
@with string
@    string on
@    string loctype view
@    string .06, .208400646204
@    string linewidth 1
@    string color 1
@    string rot 0
@    string font 4
...
@    string just 0
@    string char size 1.000000
@string def "use the definition above i.e., y=1/(1+exp(-(x-a0)/a1))."
@with string
@    string on
@    string loctype view
@    string .06, .111450290792
@    string linewidth 1
@    string color 1
@    string rot 0
@    string font 4
@    string just 0
@    string char size 1.000000
@string def "Alternatively, from File/Open select 'logistic.fit'."
@with string
@    string on
@    string loctype view
@    string .06, .07
...
@    string just 0
@    string char size 1.000000
@string def "Press 'Load as is' to see initial fit. Press 'Run 5 steps'. Curves should coinside."
@with g0
@g0 on
@g0 label off
@g0 hidden false
