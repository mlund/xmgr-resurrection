...
void putparms(int gno, FILE* pp, int embed) {
    ...
    case FREE:
        ...
        break;
    case LANDSCAPE:
        strcpy(tmpstr1, "landscape");
        break;
    case PORTRAIT:
        strcpy(tmpstr1, "portrait");
        break;
    case FIXED:
        strcpy(tmpstr1, "fixed");
        break;
    default:
        strcpy(tmpstr1, "free");
        break;
            ...
            for (i = 0; i < g[gno].maxplot; i++) {
                ...
                if (isactive_set(gno, i)) {
                    ...
                    */
                    ...
                    fprintf(pp, "%s    s%1d fill with %s\n", embedstr, i, p.fillusing == COLOR ? "color" : "pattern");
                    ...
                    if (is_hotlinked(gno, i)) {
                        fprintf(pp, "%s    s%1d link %s \"%s\"\n", embedstr, i, p.hotsrc == DISK ? "disk" : "pipe",
                                p.hotfile);
                    }
